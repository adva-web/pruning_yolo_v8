#!/usr/bin/env python3
"""
Pure Gamma Pruning Experiment: Blocks 1, 2, 3
- Blocks 1, 2, 3: Gamma pruning (BN gamma-based channel selection)
...
def main():
    print("=" * 80)
    print("PURE GAMMA PRUNING EXPERIMENT: BLOCKS 1, 2, 3")
    print("=" * 80)
    ...
    # Pruning plan: blocks 1,2,3 (conv 0)
    pruning_config = [
    ...
    # Save
    out_path = "runs/detect/gamma_pruning_blocks_123.pt"
